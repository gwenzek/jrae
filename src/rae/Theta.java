...
public class Theta implements Serializable {
    ...
    protected void fixIndices() {
        Wbegins[0] = 0;
        Wends[0] = hiddenSize * visibleSize - 1;                    //W1
        Wbegins[1] = Wends[0] + 1;
        Wends[1] = Wbegins[1] + hiddenSize * visibleSize - 1;        //W2
        Wbegins[2] = Wends[1] + 1;
        Wends[2] = Wbegins[2] + hiddenSize * visibleSize - 1;        //W3
        Wbegins[3] = Wends[2] + 1;
        Wends[3] = Wbegins[3] + hiddenSize * visibleSize - 1;        //W4
        Wbegins[4] = Wends[3] + 1;
        Wends[4] = Wbegins[4] + hiddenSize * dictionaryLength - 1;    //We
        Wbegins[5] = -1;
        Wends[5] = -1;                                                //Wcat

        bbegins[0] = Wends[4] + 1;
        bends[0] = bbegins[0] + hiddenSize - 1;        //b1
        bbegins[1] = bends[0] + 1;
        bends[1] = bbegins[1] + visibleSize - 1;        //b2
        bbegins[2] = bends[1] + 1;
        bends[2] = bbegins[2] + visibleSize - 1;        //b3
        bbegins[3] = -1;
        bends[3] = -1;    //b4
        bbegins[4] = -1;
        bends[4] = -1;    //be
